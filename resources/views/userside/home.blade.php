		...
		<div class="ads-grid py-5">
			<div class="container py-md-5 py-4">
				...
				<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
					<span class="font-weight-normal">Our</span> New Products
				...
				<div class="agileinfo-ads-display col-lg-9 order-lg-last order-first">
					<div class="wrapper">
						...
						<div class="product-sec1 px-lg-4">
							<div class="row">
								@foreach ($productrarry as $pdata)
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="../upload/{{$pdata->img}}" alt="" class="img-fluid">
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="">{{$pdata->p_name}}</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">₹{{$pdata->p_price}}
												</span>
												<del>₹</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="" method="post">
													@csrf
													<a href="{{url('detail',$pdata->p_id)}}" class="btn btn-style btn-style-secondary mt-3">Add to cart</a>
												</form>
											</div>
										</div>
									</div>
							...
							<div class="product-sec1 product-sec2">
								<div class="row p-5">
									...
									<div class="col-md-8 bg-right-nut">
										<img src={{asset("images/image1.png")}} alt="" class="img-fluid">
									</div>
								</div>
							</div>
						</div>
