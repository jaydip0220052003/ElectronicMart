		...
		<div class="ads-grid py-5">
			<div class="container py-md-0 py-4">
				...
				<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
					<span class="font-weight-normal"></span>ORDER
				</h3>
				<!-- //tittle heading -->
				<div class="row">
					<!-- product right -->
					...
					<div class="wrapper">
						...
						@if(count($products)>0)
							<table class="timetable_sub">
								...
								@foreach ($productarray as $pdata )
								<?php
								$total += intval($detail['p_price']) * intval($detail['qty']);
								?>
								<tr style='border-bottom: 1px solid #ddd;'>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['ordermaster_id']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['order_date']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['order_status']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail["shipping_name"]}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['shipping_mobileno']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['shipping_address']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'>{{$detail['payment_mode']}}</td>
									<td style='padding: 10px; border: 1px solid #ddd;'><a href="{{url('detail',$pdata->p_id)}}" class="btn btn-style btn-style-secondary mt-3">More</a>
									</td>								
								</tr>
								@endforeach
								@endforeach
							...
							@else
							<div class='alert alert-warning alert-icon my-3' role='alert'><i class='fas fa-exclamation-triangle'></i> No Order Found !</div>
							@endif
						</div>
						<hr>
