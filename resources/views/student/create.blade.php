                ...
                <form action="{{route('students.store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text"class="form-control" id="exampleInputPassword1" name="name" value="" placeholder="name">
                    </div> 
                    <!-- radio -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" name="mobile"value="" placeholder="Enter MobileNo">
                    </div>
                    <div class="form-group">
                        <label>Address</label>
